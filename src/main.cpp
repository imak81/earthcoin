...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // EarthCoin: 1 days
static const int64 nTargetSpacing = 120; // EarthCoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x23e428724ca96f587dd49c1951f17734dea2991ba8701fd02fbd993b8faea373");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Traditionally how need it";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xfc3a93c476e6c3a13f1a1ed09e37c6b2b3b5b5734335f9997ab7ff2da112ac7d"));
